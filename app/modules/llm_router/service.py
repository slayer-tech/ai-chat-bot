...
async def generate_response(
    ...
    full_system += (
        ...
        "1. Если ответ есть в базе знаний (RAG) или FAQ — отвечай из них. Это приоритет №1.\n"
        "2. Информационные вопросы (Wi-Fi, адрес, время работы, длительность приёма, как добраться) — "
