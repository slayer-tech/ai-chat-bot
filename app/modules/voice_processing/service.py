"""Voice message processing via Yandex SpeechKit — COMMENTED OUT FOR TESTING."""
...
async def process_voice_if_needed(voice_url: Optional[str]) -> str:
    ...
    NOTE: Yandex SpeechKit temporarily disabled for testing.
    ...
    return "[голосовое сообщение — SpeechKit отключен для тестов]"
